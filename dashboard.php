...
<section class="stat-grid">
  ...
  <a class="stat-card stat-yellow" href="inventory.php"><span class="stat-icon"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M3.5 9.2 12 4l8.5 5.2v10.1H3.5V9.2Z" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linejoin="round"/><path d="M3.5 9.2H20.5M7 12.2h3v3H7v-3Zm7 0h3v3h-3v-3ZM7 17.2h3v2.1H7v-2.1Zm7 0h3v2.1h-3v-2.1Z" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/></svg></span><div><small>Total Stock</small><strong><?=number_format($stock)?></strong><em>Eggs in stock</em></div><b class="arrow">›</b></a>
